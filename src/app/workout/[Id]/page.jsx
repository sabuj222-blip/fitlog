...
export default function WorkoutDetailPage() {
  ...
  return (
    <div className="bg-[#0b0c10] text-white min-h-[calc(100vh-80px)] py-4 px-4 sm:px-8 flex items-center justify-center">
      <div className="max-w-6xl w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
        
          <div className="lg:col-span-6 w-full">
            <div className="relative w-full aspect-square max-h-[420px] bg-[#14161f] rounded-3xl overflow-hidden border border-zinc-800/80 shadow-xl mx-auto">
              <Image
          ...
          <div className="lg:col-span-6 flex flex-col justify-start">
            <div className="bg-[#12141c] border border-zinc-800/80 rounded-3xl p-5 sm:p-6 space-y-4">
              <div>
                <h1 className={`${oswald.className} text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-tight text-white mb-2`}>
                  {workout.name}
                </h1>
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed mb-3 font-mono">
              ...
              <div className="bg-[#181a24] border border-zinc-800/90 rounded-2xl p-4 text-xs font-mono space-y-2">
                ...
                <div className="flex justify-between items-center border-b border-zinc-800/60 pb-2">
                  <span className={`${oswald.className} text-zinc-500 uppercase tracking-wider font-semibold`}>SETS / REPS</span>
                  <span className="text-zinc-200">{workout.sets || "4"} / {workout.reps || "8-12"}</span>
                </div>
                <div className="flex justify-between items-center border-b border-zinc-800/60 pb-2">
              ...
              <div>
                <h3 className={`${oswald.className} font-bold text-sm uppercase text-white mb-2 tracking-wider`}>
                  INSTRUCTIONS
                </h3>
                <ol className="space-y-1.5 text-xs text-zinc-400 font-mono leading-relaxed">
